          ...
          <div className="flex flex-col justify-center space-y-8">
            <div>
              <h1 className="text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl">
                Somos <span className="text-rose-500">Serios</span> por
                <br />
                <span className="text-orange-500">Comida</span> y Entrega.
              </h1>
              <p className="mt-4 text-muted-foreground max-w-xl">
                Los mejores cocineros y los mejores repartidores a su servicio. Comida caliente y deliciosa llegará a usted en 60 minutos.
              </p>
            </div>
